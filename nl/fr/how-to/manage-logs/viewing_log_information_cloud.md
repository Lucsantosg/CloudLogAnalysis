...
Utilisez la commande `bx logging log-show` avec les options **-s** pour définir la date de début et **-e** pour définir la date de fin. Par exemple :

* `bx logging log-show` fournit des informations pour les deux dernières semaines.
* `bx logging log-show -s 2017-05-03` fournit des informations pour la période comprise entre le 3 mai 2017 et la date en cours.
* `bx logging log-show -s 2017-05-03 -e 2017-05-08` fournit des informations pour la période comprise entre le 3 mai 2017 et le 8 mai 2017. 
...
Pour obtenir des informations sur un type de journal pour une période donnée, utilisez la commande `bx logging log-show` avec les options **-t** pour spécifier le type de journal, **-s** pour définir la date de début et **-e** pour définir la date de fin. Par exemple

* `bx logging log-show -t syslog` fournit des informations sur les journaux de type *syslog* pour les deux dernières semaines.
* `bx logging log-show -s 2017-05-03 -t syslog` fournit des informations sur les journaux de type *syslog* pour la période du 3 mai 2017 à la date en cours.
* `bx logging log-show -s 2017-05-03 -e 2017-05-08 -t syslog` fournit des informations sur les journaux de type *syslog* pour la période du 3 mai 2017 au 8 mai 2017. 
...
Pour obtenir des informations sur les journaux qui sont disponibles au niveau du compte pour une période donnée, utilisez la commande `bx logging log-show` avec les options **-r account** et **-i** afin de définir l'ID du compte. Vous pouvez également spécifier les options **-t** pour spécifier le type de journal, **-s**
