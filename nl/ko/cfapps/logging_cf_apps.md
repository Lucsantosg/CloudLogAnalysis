...
# {{site.data.keyword.Bluemix_notm}}에서 Cloud Foundry 앱의 로깅
...
* 애플리케이션의 최신 활동을 보기 위해 {{site.data.keyword.Bluemix_notm}} UI에서 로그를 분석합니다.
    ...
    {{site.data.keyword.Bluemix_notm}}에서 각 Cloud Foundry 애플리케이션에 사용 가능한 **로그** 탭을 통해 로그를 보고 필터링하고 분석할 수 있습니다. 자세한 정보는 [{{site.data.keyword.Bluemix_notm}} UI에서 CF 앱 로그 분석](/docs/services/CloudLogAnalysis/cfapps/launch_logs_cloud_ui_cf.html#launch_logs_cloud_ui_cf)을 참조하십시오.
...
Kibana를 사용하여 Cloud Foundry 앱에 대한 로그를 분석하는 방법을 알아보려면 [Kibana에서 Cloud Foundry 앱에 대한 로그 분석](/docs/tutorials/application-log-analysis.html#generate-access-and-analyze-application-logs)을 참조하십시오.
