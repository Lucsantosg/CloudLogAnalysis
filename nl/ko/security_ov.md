...
* [{{site.data.keyword.Bluemix_notm}} 명령 bx 서비스를 사용하여 로그를 영역으로 보내는 로깅 토큰 가져오기](/docs/services/CloudLogAnalysis/security/logging_token.html#logging_token_cloud_cli)
* [Log Analysis CLI(CF 플러그인)를 사용하여 로그를 영역으로 보내는 로깅 토큰 가져오기](/docs/services/CloudLogAnalysis/security/logging_token.html#logging_token_cf_plugin)
...
로그를 계정 도메인으로 보내려면 [Log Analysis API를 사용하여 로그를 계정 도메인으로 보내는 로깅 토큰 가져오기](/docs/services/CloudLogAnalysis/security/logging_token.html#logging_acc_token_api)를 참조하십시오. 
