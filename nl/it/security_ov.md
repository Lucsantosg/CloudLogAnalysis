...
Per consentire a un utente di gestire i log o di visualizzarli, è necessario concedergli le autorizzazioni in {{site.data.keyword.cloud_notm}} a lavorare con il servizio {{site.data.keyword.loganalysisshort}}.
