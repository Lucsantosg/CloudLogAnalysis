...
3. No painel do Kibana, clique no ícone **Pasta** ![Ícone Pasta](images/logging_folder.jpg "Ícone Pasta") para exibir um menu que lista todos os painéis recentes. 
...
5. Opcionalmente, é possível incluir mais campos em sua seção de filtro, por exemplo, **instance_id** para ativar ou desativar a filtragem de registros por ID da instância. 
    ...
    3. Inclua um filtro.
        ...
        Para incluir um filtro que inclua informações sobre esse valor de campo específico, clique no ícone **Lupa** ![Ícone de lupa](images/logging_magnifying_glass.jpg "Ícone de lupa") na linha da tabela que contém o campo que você deseja filtrar. 
	
        Para incluir um filtro que exclua informações sobre esse valor de campo específico, clique no ícone **Exclusão** ![Ícone Exclusão](images/logging_exclusion_icon.png "Ícone Exclusão") na linha da tabela que contém o campo que você deseja filtrar.  
...
Você criou um painel que filtra suas entradas de log por ID do aplicativo e ID da instância. É possível carregar seu painel salvo a qualquer momento clicando no ícone **Pasta** ![Ícone Pasta](images/logging_folder.jpg "Ícone Pasta") e selecionando seu painel pelo nome.
