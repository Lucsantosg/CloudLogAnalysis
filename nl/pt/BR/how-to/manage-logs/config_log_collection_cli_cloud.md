...
2. Se o plug-in estiver instalado, execute o `bx plugin uninstall` para desinstalar o plug-in da CLI de criação de log.
...
Use o comando 'bx plugin show logging-cli' para mostrar os detalhes do plug-in. 
