...
{{site.data.keyword.cloud_notm}} 中有兩種類型的角色可控制使用者在使用 {{site.data.keyword.loganalysisshort}} 服務時可執行的動作：
...
如需相關資訊，請參閱[取得 IAM 記號](/docs/services/CloudLogAnalysis/security?topic=cloudloganalysis-auth_iam1#auth_iam1)。
