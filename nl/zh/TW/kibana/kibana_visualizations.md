...
| [儲存視覺效果](kibana_visualizations.html#save) | 您可以儲存視覺效果，以供稍後重複使用。|
...
3. 在**或者，從已儲存的搜尋**中選取您先前儲存的視覺效果，或在**從新搜尋，選取索引**區段中選取索引。
...
4. 配置查詢。
    ...
    * 如果您選取**從新搜尋，選取索引**，請定義新的查詢。此查詢用來定義視覺效果所擷取及使用的部分資料。
