...
# Sending logs from outside the {{site.data.keyword.cloud_notm}}
{: #log_ingestion}
...
* An {{site.data.keyword.IBM_notm}}ID to log in to the {{site.data.keyword.cloud_notm}}. This user ID must have permissions to work with the {{site.data.keyword.loganalysisshort}} service in a space in {{site.data.keyword.cloud_notm}}. The space is the domain in the {{site.data.keyword.cloud_notm}} where you plan to send and analyze logs.
...
For more information about configuring your local environment to send logs to the {{site.data.keyword.loganalysisshort}} service, see [Sending on-premises data to a space in the {{site.data.keyword.cloud_notm}}](/docs/services/CloudLogAnalysis/how-to/send-data?topic=cloudloganalysis-send_data_mt#send_data_mt).
...
The following table lists the URLs that you must use to send logs into the {{site.data.keyword.cloud_notm}}:
