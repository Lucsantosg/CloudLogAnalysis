...
Here are the answers to common questions about using {{site.data.keyword.Bluemix}} CLI with the {{site.data.keyword.loganalysisshort}} service. 
{:shortdesc}
...
4. Verify the installation of the CF plugin. For example, check the version of the CF plugin. Run the following command:
...
5. Verify the installation of the {{site.data.keyword.Bluemix_notm}} CLI. For example, check the version of the plugin. Run the following command:
